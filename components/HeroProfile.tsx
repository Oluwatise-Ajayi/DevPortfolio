        ...
        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
          <div className="relative">
            <div className="w-32 h-32 rounded-full p-1 border-2 border-green-500/50 shadow-[0_0_20px_rgba(34,197,94,0.2)]">
              <img 
                src="https://placehold.co/150x150/1f2937/4ade80?text=Profile" 
                alt="Profile" 
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-5xl font-bold text-white mb-4 tracking-tight">
              Hello, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-600">Alex Chen</span>
            </h1>
            <p className="text-gray-400 text-lg leading-relaxed max-w-xl">
              Systems Engineer & Backend Developer specialized in building scalable infrastructure, distributed systems, and robust APIs.
            </p>
            ...
            <div className="flex gap-4 mt-8 justify-center md:justify-start">
              ...
              <button className="bg-transparent border border-white/20 text-white font-bold py-3 px-6 rounded-full flex items-center gap-2 hover:bg-white/10 transition-colors">
